...
|Election of TC reps to the PC|Any member|all|assumed|assumed|simple majority
...
|Recommendation for PC approval|TC Voting Member|electronic|assumed|1/3|2X Yes:NO and 15% YES
...
If the TC electronic vote for recommending an action passes, then the action proceeds to the PC for an approval vote per the PC Policies and Procedures.
...
For a Standard adoption vote, then the SWG shall respond in writing to all comments within 30 days of the completion of the vote. A TC vote that passes cannot proceed to the PC for approval unless all NO votes are addressed.
