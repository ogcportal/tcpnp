...
[[h.2xcytpi]]SCs have Voting TC Member-only voting. As with all OGC groups, each Voting TC Member has only one vote per SC. SCs are long-standing entities with general portfolios or mission. OGC staff can chair TC SCs. Any OGC member can attend a SC meeting and participate.
...
[[h.upglbi]]BP documents have version numbers that shall start at 1.0.
...
=== [[h.4k9eaeh31c5e]][[_Ref461705101]]Policy for the Retiring, Deprecating, or Rescinding OGC Documents
